      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="max-w-dvh">
          ...
          <p>
            ...
            <br></br>
            HayatiSweet lets you create your own taste of happiness,sweet, playful, and totally you.
          </p>
        ...
        <div className="max-w-md pt-2.5">
          ...
          <span className="mt-4" >hayatisweet@gmail.com</span>
        </div>
        </div>

        {/* RIGHT */}
        <div className="text-right">
          <h3 className="font-['Jua'] text-xl mb-2">HayatiSweet</h3>
          <p className="text-sm">© 2025 HayatiSweet</p>
